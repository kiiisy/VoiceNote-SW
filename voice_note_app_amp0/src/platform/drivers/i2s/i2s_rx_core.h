...
private:
    ...
    /**
     * @struct I2sRx::Regs
     * @brief I2S Rx / Clock MUX レジスタアクセス用ラッパー
     */
    struct Regs
    {
    ...
    static void OverflowHandlerEntry(void *ref);
    ...
    XI2s_Rx i2s_{};     // I2S Rxの実体
    Regs    regs_{0};   // I2S Rxレジスタ
