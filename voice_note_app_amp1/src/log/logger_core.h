...
public:
    ...
    void log(Level lvl, const char *file, int32_t line, const char *func, const char *fmt, ...)
    ...
    {
    public:
        Scope(const char *file, int32_t line, const char *func, const char *name = nullptr);
        ~Scope();
...
private:
    Logger() = default;
    void               vprint(Level lvl, const char *file, int32_t line, const char *func, const char *fmt,
                              va_list ap);
